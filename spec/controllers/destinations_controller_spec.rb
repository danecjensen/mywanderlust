  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved destination as @destination" do
        ...
        post :create, {:destination => { "trip_id" => "invalid value" }}, valid_session
        assigns(:destination).should be_a_new(Destination)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested destination" do
        ...
        Destination.any_instance.should_receive(:update_attributes).with({ "trip_id" => "1" })
        put :update, {:id => destination.to_param, :destination => { "trip_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the destination as @destination" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Destination.any_instance.stub(:save).and_return(false)
        put :update, {:id => destination.to_param, :destination => { "trip_id" => "invalid value" }}, valid_session
        assigns(:destination).should eq(destination)
      end
